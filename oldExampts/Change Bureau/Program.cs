...
namespace Change_Bureau
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double biitcoins = double.Parse(Console.ReadLine());
            double yuan = double.Parse(Console.ReadLine());
            double commission = double.Parse(Console.ReadLine());
            double bitcoincEUR = (biitcoins * 1168) / 1.95;
            double yuanEUR = ((yuan * 0.15) * 1.76) / 1.95;
            double total = bitcoincEUR + yuanEUR;
